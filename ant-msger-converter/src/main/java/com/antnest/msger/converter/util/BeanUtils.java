package com.antnest.msger.converter.util;

import com.antnest.msger.converter.bvo.Cache;
...
//                    log.error("设置对象值失败,类型不匹配{}", setter);
                    System.out.println("设置对象值失败,类型不匹配{}" + setter);
                    return;
                }
            }
