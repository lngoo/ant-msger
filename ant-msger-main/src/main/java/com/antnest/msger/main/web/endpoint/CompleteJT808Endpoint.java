...
public class CompleteJT808Endpoint extends BaseJt808Endpoint {

    @Autowired
    RequestDataPublisher jt808Sender;

    private static final Logger logger = LoggerFactory.getLogger(CompleteJT808Endpoint.class.getSimpleName());
