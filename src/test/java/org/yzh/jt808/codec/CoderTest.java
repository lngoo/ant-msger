...
public class CoderTest {
    ...
    private static final JT808MessageDecoder decoder = new JT808MessageDecoder(new MessageToMessageDecoder() {
        @Override
    ...
    public static Message<Register> register1() {
        ...
        res.setProvinceId(0);
        res.setCityId(01);
        res.setManufacturerId("MAKER");
        res.setTerminalType("PROBOOK zhan66-amd");
        res.setTerminalId("A2");
        res.setLicensePlateColor(01);
        res.setLicensePlate("川A7777");

        Message<Register> msg = new Message<>();
        msg.setType(0X0100);
        msg.setMobileNumber("013888887777");
        msg.setSerialNumber(101);
        msg.setBody(res);
        return msg;
    }
...
//        selfCheck(Register.class, "0100002c0138888877770065000000014d414b4552202050524f424f4f4b207a68616e36362d616d640000000000413201b4a8413737373733");
